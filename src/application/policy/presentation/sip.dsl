...
routes: {
    ...
    route:GET_SHOP_CATALOG := { path:"/shop/catalog"; method:"GET"; "type":"view"; view:"catalog/Catalog.xml" };
    route:GET_PRODUCT_BILANCE := { path:"/shop/product/bilancia-touch-15"; method:"GET"; "type":"view"; view:"product/Product.xml" };
    route:GET_PRODUCT_POS := { path:"/shop/product/cassa-pos-pro"; method:"GET"; "type":"view"; view:"product/Product.xml" };
    route:GET_PRODUCT_CASHMATIC := { path:"/shop/product/cashmatic-strong"; method:"GET"; "type":"view"; view:"product/Product.xml" };
    route:GET_PRODUCT_SOFTWARE := { path:"/shop/product/software-retail-suite"; method:"GET"; "type":"view"; view:"product/Product.xml" };
    route:GET_CART := { path:"/shop/cart"; method:"GET"; "type":"view"; view:"cart/Cart.xml" };
    route:POST_CART := { path:"/shop/cart"; method:"POST"; "type":"view"; view:"cart/Cart.xml" };
    route:GET_CART_REMOVE := { path:"/shop/cart/remove"; method:"GET"; "type":"view"; view:"cart/Cart.xml" };
    route:GET_CHECKOUT := { path:"/shop/checkout"; method:"GET"; "type":"view"; view:"checkout/Checkout.xml" };
    route:POST_ORDER := { path:"/shop/order/confirmation"; method:"POST"; "type":"view"; view:"order/Confirmation.xml" };
    route:GET_ACCOUNT := { path:"/account"; method:"GET"; "type":"view"; view:"account/Account.xml" };
    route:GET_ACCOUNT_LOGIN := { path:"/account/login"; method:"GET"; "type":"view"; view:"account/Login.xml" };
    ...
    route:GET_ACCOUNT_ORDERS := { path:"/account/orders"; method:"GET"; "type":"view"; view:"account/Orders.xml" };
    route:GET_ORDER := { path:"/account/orders/{id}"; method:"GET"; "type":"view"; view:"account/Orders.xml" };
