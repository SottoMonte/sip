...
routes: {
    ...
    route:GET_ACCOUNT_TICKETS := { path:"/account/tickets"; method:"GET"; "type":"view"; view:"account/Tickets.xml"; controller:"account" };
    route:GET_ACCOUNT_TICKET_NEW := { path:"/account/tickets/new"; method:"GET"; "type":"view"; view:"account/Tickets.xml"; controller:"account" };
    route:GET_ACCOUNT_TICKET_DETAIL := { path:"/account/tickets/{id}"; method:"GET"; "type":"view"; view:"account/Tickets.xml"; controller:"account" };
    route:GET_ACCOUNT_BOOKINGS := { path:"/account/bookings"; method:"GET"; "type":"view"; view:"account/Bookings.xml"; controller:"account" };
    route:GET_ACCOUNT_BOOKING_NEW := { path:"/account/bookings/new"; method:"GET"; "type":"view"; view:"account/Bookings.xml"; controller:"account" };
    route:GET_ACCOUNT_BOOKING_RESCHEDULE := { path:"/account/bookings/reschedule"; method:"GET"; "type":"view"; view:"account/Bookings.xml"; controller:"account" };
    route:GET_ACCOUNT_DOCUMENTS := { path:"/account/documents"; method:"GET"; "type":"view"; view:"account/Documents.xml"; controller:"account" };
    route:GET_ACCOUNT_DOCUMENT := { path:"/account/documents/{id}"; method:"GET"; "type":"view"; view:"account/Documents.xml"; controller:"account" };
    route:GET_ACCOUNT_INVENTORY := { path:"/account/inventory"; method:"GET"; "type":"view"; view:"account/Inventory.xml"; controller:"account" };
    route:GET_ACCOUNT_RETURNS := { path:"/account/returns"; method:"GET"; "type":"view"; view:"account/Returns.xml"; controller:"account" };
    route:GET_ACCOUNT_RETURN_NEW := { path:"/account/returns/new"; method:"GET"; "type":"view"; view:"account/Returns.xml"; controller:"account" };
    route:GET_ACCOUNT_RETURN_DETAIL := { path:"/account/returns/{id}"; method:"GET"; "type":"view"; view:"account/Returns.xml"; controller:"account" };
...
rules : {
    ...
    "/account/tickets": [policies.GET_ALLOW_ALL];
    "/account/tickets/new": [policies.GET_ALLOW_ALL];
    "/account/tickets/{id}": [policies.GET_ALLOW_ALL];
    "/account/bookings": [policies.GET_ALLOW_ALL];
    "/account/bookings/new": [policies.GET_ALLOW_ALL];
    "/account/bookings/reschedule": [policies.GET_ALLOW_ALL];
    "/account/documents": [policies.GET_ALLOW_ALL];
    "/account/documents/{id}": [policies.GET_ALLOW_ALL];
    "/account/inventory": [policies.GET_ALLOW_ALL];
    "/account/returns": [policies.GET_ALLOW_ALL];
    "/account/returns/new": [policies.GET_ALLOW_ALL];
    "/account/returns/{id}": [policies.GET_ALLOW_ALL];
